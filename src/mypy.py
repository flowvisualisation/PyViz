...
D1 = pp.pload(0,w_dir=wdir) # Loading the data into a pload object D.
D2 = pp.pload(0,w_dir=wdir)

## SMART WAY##
I = pp.Image()
I.multi_disp(log10(D0.rho),log10(D1.prs),D2.vx2,x1=D0.x1,x2=D0.x2,Ncols=3,label1=3*['x'],
