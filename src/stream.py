OpenDatabase("localhost:/Users/gmurphy/Dropbox/beaumont/fields_electrons_1.vtk", 0)
DefineVectorExpression("b", "{Bx,By,Bz}")
DefineVectorExpression("a", "{Bx,By,Bz}")
AddPlot("Streamline", "b", 1, 1)
SetActivePlots(0)
##xxx
# Begin spontaneous state
View3DAtts = View3DAttributes()
View3DAtts.viewNormal = (-0.981375, 0.117486, 0.151985)
View3DAtts.focus = (19.5, 20, 20.5)
View3DAtts.viewUp = (0.15043, -0.0220466, 0.988375)
View3DAtts.viewAngle = 30
View3DAtts.parallelScale = 34.6482
View3DAtts.nearPlane = -69.2965
View3DAtts.farPlane = 69.2965
View3DAtts.imagePan = (0, 0)
View3DAtts.imageZoom = 1
View3DAtts.perspective = 1
View3DAtts.eyeAngle = 2
View3DAtts.centerOfRotationSet = 0
View3DAtts.centerOfRotation = (19.5, 20, 20.5)
...
StreamlineAtts.radius = 15
StreamlineAtts.sphereOrigin = (20, 20, 20)
