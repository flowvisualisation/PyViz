...
AnnotationAtts.userInfoFont.font = AnnotationAtts.userInfoFont.Times  # Arial, Courier, Times
...
AnnotationAtts.databaseInfoFont.font = AnnotationAtts.databaseInfoFont.Times  # Arial, Courier, Times
...
ContourAtts.changedColors = (1, 2, 3)
...
ContourAtts.SetMultiColor(1, (255, 255, 0, 51))
ContourAtts.SetMultiColor(2, (0, 255, 0, 91))
ContourAtts.SetMultiColor(3, (0, 0, 255, 255))
...
im2= CreateAnnotationObject("Image")          
im2.visible = 1
im2.active = 1
im2.position = (0.75, 0.05)
im2.transparencyColor = (0, 0, 0, 255)
im2.useTransparencyColor = 0
im2.width = 100
im2.height = 100
im2.maintainAspectRatio = 1
im2.image = ("kh_3d_growth.jpg")
...
for state in range(TimeSliderGetNStates()):
	SetTimeSliderState(state)
        ...
        print state
        sw.fileName = "%s_contour_%04d" %("curlvz",  state)
        dt=0.1
        time = dt*state
        slider.text =  "Time = %g" % time
        sw.height = 768
        sw.stereo =0
        sw.width = 1366
