...
DefineVectorExpression("b", "{bx1,bx2}")
DefineVectorExpression("v", "{vx1,vx2}")
...
StreamlineAtts.lineStart = (0, -6, 0)
StreamlineAtts.lineEnd = (0, 6, 0)
...
StreamlineAtts.sampleDensity0 = 13
